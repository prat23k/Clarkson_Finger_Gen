...
if 1:
    ...
    downgrade_D_by = 1e-3                       # downgrade lr of D

    # Dataset.
    desc += '-cfg_dataset';     dataset = EasyDict(tfrecord_dir='/workspace/stylegan_K1/tfrecords'); train.mirror_augment = True
    ...
    sched.D_lrate_dict.update((key, value * downgrade_D_by) for key, value in sched.D_lrate_dict.items())
